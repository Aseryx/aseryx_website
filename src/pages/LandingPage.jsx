        ...
        <div className="min-h-screen bg-[#F9F8F6] dark:bg-[#0a0a0a] text-[#1A1A1A] dark:text-white font-sans selection:bg-brand-orange selection:text-black overflow-x-hidden">
            ...
            <section id="main-content" className="relative min-h-screen flex flex-col pt-24 md:pt-40">
                ...
                <div className="absolute inset-0 z-0 overflow-hidden bg-[#F9F8F6] dark:bg-[#0a0a0a]">
                    ...
                    <picture>
                        ...
                        <img
                            ...
                            width="1024"
                            height="1024"
                            className="absolute inset-0 w-full h-full object-cover opacity-60 dark:opacity-40 mix-blend-multiply dark:mix-blend-screen animate-hero-drift"
                            loading="eager"
                            fetchPriority="high"
                        />
                    </picture>
                ...
                <div className="relative z-10 w-full max-w-7xl mx-auto px-4 md:px-8 flex-grow pb-0 md:pb-32">
                    <div className="max-w-5xl">
                        ...
                        <h1 className="font-display text-4xl sm:text-5xl md:text-[clamp(3rem,8vw,6rem)] leading-[1.05] tracking-tight mb-6 md:mb-8">
                            ...
                            <span className="block text-[#1A1A1A] dark:text-white animate-fade-up delay-200 opacity-0" style={{ animationFillMode: 'forwards' }}>
                                <span className="italic text-brand-orange">infrastructure</span> for AI.
                            </span>
                        </h1>

                        <p className="text-lg md:text-xl text-[#6B7280] dark:text-gray-400 leading-relaxed mb-8 md:mb-10 max-w-2xl animate-fade-up delay-300 opacity-0" style={{ animationFillMode: 'forwards' }}>
                            Institutions license sensitive data to AI builders.
                            <span className="text-[#1A1A1A] dark:text-white block mt-2">Quality proven. Data never moves.</span>
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 animate-fade-up delay-400 opacity-0 pb-12 md:pb-0" style={{ animationFillMode: 'forwards' }}>
                            <a
                                ...
                                className="group relative px-8 py-4 bg-white text-black font-medium tracking-wide text-sm rounded-sm hover:bg-gray-100 transition-colors flex items-center justify-center gap-3 focus:outline-none focus:ring-2 focus:ring-brand-orange focus:ring-offset-2 focus:ring-offset-[#F9F8F6] dark:focus:ring-offset-[#0a0a0a]"
                            ...
                            <Link
                                to="/partners"
                                className="group relative px-8 py-4 bg-transparent border border-gray-300 dark:border-gray-700 text-[#1A1A1A] dark:text-white font-medium tracking-wide text-sm rounded-sm hover:border-brand-orange hover:text-brand-orange transition-colors flex items-center justify-center gap-3 focus:outline-none focus:ring-2 focus:ring-brand-orange focus:ring-offset-2 focus:ring-offset-[#F9F8F6] dark:focus:ring-offset-[#0a0a0a]"
                            >
                                Monetize Your Data
                ...
                <div className="absolute bottom-8 right-8 hidden md:flex flex-col items-center gap-4 animate-fade-in delay-1000">
                    <div className="w-[1px] h-20 bg-gradient-to-b from-transparent via-gray-400 dark:via-gray-500 to-transparent"></div>
                    <span className="text-[10px] font-mono text-[#6B7280] dark:text-gray-400 uppercase tracking-widest rotate-90 origin-center translate-y-8">Scroll</span>
                </div>

                {/* HERO STATS BAR */}
                <div className="relative mt-auto border-t border-[#E8E4DE]/50 dark:border-gray-700 bg-[#F9F8F6]/80 md:bg-[#F9F8F6]/50 dark:bg-[#0a0a0a]/80 backdrop-blur-sm">
                    <div className="max-w-7xl mx-auto px-4 md:px-8 py-6 md:py-8">
                        <div className="flex flex-col sm:flex-row flex-wrap gap-6 sm:gap-12 animate-fade-in delay-700 opacity-0" style={{ animationFillMode: 'forwards' }}>
                            <div>
                                ...
                                <p className="text-xl md:text-2xl font-light mt-1 text-[#1A1A1A] dark:text-white">Zero Custody Transfer</p>
                                <p className="text-[#6B7280] dark:text-gray-400 text-xs mt-1">Data stays with you. Always.</p>
                            </div>
                            <div>
                                <p className="font-mono text-brand-orange text-sm">02</p>
                                <p className="text-xl md:text-2xl font-light mt-1 text-[#1A1A1A] dark:text-white">Quality Proven, Not Promised</p>
                                <p className="text-[#6B7280] dark:text-gray-400 text-xs mt-1">Scored and verified before anyone pays.</p>
                            </div>
                            <div>
                                <p className="font-mono text-brand-orange text-sm">03</p>
                                <p className="text-xl md:text-2xl font-light mt-1 text-[#1A1A1A] dark:text-white">80–85% to You</p>
                                <p className="text-[#6B7280] dark:text-gray-400 text-xs mt-1">Per training run. Recurring.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {/* AUDIENCE FORK */}
            <section className="py-24 px-4 md:px-8 bg-[#F9F8F6] dark:bg-[#0a0a0a] border-t border-[#E8E4DE] dark:border-gray-800">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
                        {/* Sell Your Data */}
                        <ScrollReveal className="group relative bg-white dark:bg-[#0f0f0f] p-8 border border-[#E8E4DE] dark:border-gray-700 hover:border-brand-orange/50 transition-all duration-300" delay={100}>
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="text-2xl font-display text-[#1A1A1A] dark:text-white mb-4">Your data has buyers.</h3>
                                <p className="text-[#6B7280] dark:text-gray-400 text-sm leading-relaxed mb-6">
                                    License it without giving up control.
                                </p>
                                <Link
                                    to="/partners"
                                    className="inline-flex items-center gap-2 text-brand-orange hover:text-[#1A1A1A] dark:hover:text-white transition-colors text-sm font-medium group/link"
                                >
                                    Become a Partner
                        ...
                        {/* Buy Verified Data */}
                        <ScrollReveal className="group relative bg-white dark:bg-[#0f0f0f] p-8 border border-[#E8E4DE] dark:border-gray-700 hover:border-brand-orange/50 transition-all duration-300" delay={200}>
                            <div className="absolute inset-0 bg-gradient-to-br from-brand-orange/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                            <div className="relative z-10">
                                <div className="flex items-center gap-3 mb-6">
                                    <div className="p-3 rounded-lg bg-brand-orange/10 group-hover:bg-brand-orange/20 transition-colors">
                                ...
                                <h3 className="text-2xl font-display text-[#1A1A1A] dark:text-white mb-4">Data you can trust.</h3>
                                <p className="text-[#6B7280] dark:text-gray-400 text-sm leading-relaxed mb-6">
             ...
             <section className="py-16 md:py-32 lg:py-48 px-4 md:px-8 relative bg-[#F9F8F6] dark:bg-[#050505]">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="space-y-8 md:space-y-0 md:grid md:grid-cols-12 md:gap-6">
                        ...
                        <ScrollReveal className="md:col-span-5 relative group card-lift" delay={200}>
                            ...
                            <div className="pl-6 py-8">
                                <p className="font-mono text-[#6B7280] dark:text-gray-400 text-[10px] tracking-[0.3em] uppercase mb-4">Finance</p>
                                <p className="font-display text-[3rem] md:text-[4rem] text-brand-orange tracking-tighter leading-none mb-4">Signal<span className="text-[#6B7280] dark:text-gray-400">Destroyed</span></p>
                                <p className="text-[#4B5563] dark:text-gray-300 text-sm leading-relaxed max-w-xs">
                        ...
                        <ScrollReveal className="md:col-span-4 md:mt-16 relative group card-lift" delay={400}>
                            ...
                            <div className="pt-8 pb-6">
                                <div className="flex items-baseline gap-2 mb-6">
                                    <EyeOff className="w-12 h-12 text-[#1A1A1A] dark:text-white" />
                                </div>
                                <h3 className="text-2xl text-[#1A1A1A] dark:text-white font-display mb-2">Data Locked Away</h3>
                        ...
                        <ScrollReveal className="md:col-span-3 md:mt-32 relative card-lift" delay={600}>
                            <div className="absolute top-0 right-0 w-16 h-16 border-t border-r border-gray-200 dark:border-gray-800 group-hover:border-brand-orange transition-colors duration-500"></div>
                            <div className="py-8">
                                <p className="font-mono text-[10px] text-[#6B7280] dark:text-gray-500 tracking-widest uppercase mb-8">What Changes</p>
                                <div className="relative">
                                    <p className="font-display text-4xl md:text-5xl text-[#1A1A1A] dark:text-white tracking-tight">Verify</p>
                                    <p className="text-brand-orange text-lg mt-1">don't reveal</p>
                                </div>
                                <p className="text-[#4B5563] dark:text-gray-300 text-sm mt-8 leading-relaxed">
             ...
             {/* HOW IT WORKS */}
            <section className="py-16 md:py-32 lg:py-48 px-4 md:px-8 bg-[#F9F8F6] dark:bg-[#050505] relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    <div className="relative">
                        {/* Connection line */}
                        <div className="hidden lg:block absolute top-1/2 left-0 right-0 h-px bg-gradient-to-r from-gray-200 dark:from-gray-800 via-brand-orange/50 to-gray-200 dark:to-gray-800"></div>

                        <div className="flex flex-col lg:flex-row items-stretch gap-6 lg:gap-0">
                            <div className="flex-1 relative z-10">
                                <div className="h-full p-8 lg:pr-12 relative bg-white/50 dark:bg-[#0a0a0a]/50 backdrop-blur-sm border border-gray-200 dark:border-gray-800 lg:border-none">
                                    <div className="absolute top-0 left-0 w-8 h-8 border-l-2 border-t-2 border-gray-200 dark:border-gray-700"></div>
                                    <p className="font-mono text-[10px] text-[#6B7280] dark:text-gray-400 tracking-[0.3em] uppercase mb-6">PARTNER</p>
                                    <h3 className="font-display text-3xl mb-3 text-[#1A1A1A] dark:text-white">You Stay in Control</h3>
                                    <p className="text-[#6B7280] dark:text-gray-300 text-sm leading-relaxed">Approve every request. Set your price. Revoke anytime.</p>
                                    <div className="hidden lg:flex absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/2 w-10 h-10 bg-[#050505] border border-gray-200 dark:border-gray-800 items-center justify-center z-20">
                                        <Database className="w-4 h-4 text-[#6B7280] dark:text-gray-400" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex-1 relative z-20">
                                <div className="h-full mx-4 lg:mx-8 relative">
                                    ...
                                    <div className="relative p-8 pt-10">
                                        ...
                                        <p className="text-[#6B7280] dark:text-gray-300 text-sm leading-relaxed">Every dataset gets a quality gate and a 0-100 score. Verified, not self-reported.</p>
                                        <div className="mt-6 flex items-center gap-3">
                                            <div className="w-2 h-2 rounded-full bg-brand-orange animate-pulse"></div>
                                            <span className="text-[10px] text-[#6B7280] dark:text-gray-400 font-mono tracking-wider">CALCULATING</span>
                                        </div>
                                    </div>
                            ...
                            <div className="flex-1 relative z-10">
                                <div className="h-full p-8 lg:pl-12 relative bg-white/50 dark:bg-[#0a0a0a]/50 backdrop-blur-sm border border-gray-200 dark:border-gray-800 lg:border-none">
                                    <div className="absolute top-0 right-0 w-8 h-8 border-r-2 border-t-2 border-gray-200 dark:border-gray-700"></div>
                                    <p className="font-mono text-[10px] text-[#6B7280] dark:text-gray-400 tracking-[0.3em] uppercase mb-6">BUYER</p>
                                    <h3 className="font-display text-3xl mb-3 text-[#1A1A1A] dark:text-white">You Get Proof, Not Files</h3>
                                    ...
                                    <p className="text-[#6B7280] dark:text-gray-300 text-sm leading-relaxed mt-4">Know exactly what you're licensing before you pay.</p>
                                </div>
                            </div>
                        </div>
                    </div>
             ...
             <section className="py-16 md:py-32 lg:py-48 px-4 md:px-8 relative bg-[#F9F8F6] dark:bg-[#0a0a0a]">
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    <div className="grid lg:grid-cols-12 gap-4 md:gap-8 mb-12 md:mb-24">
                        ...
                        <div className="lg:col-span-7 lg:pt-20">
                            <ScrollReveal delay={200}>
                                <p className="text-[#4B5563] dark:text-gray-300 text-lg leading-relaxed max-w-xl">
                    ...
                    <div className="grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-px bg-gray-900/50 dark:bg-gray-800/50">
                        {/* Finance Card 1 */}
                        <ScrollReveal className="bg-white dark:bg-[#0a0a0a] p-6 md:p-10 group hover:bg-[#0f0f0f] dark:hover:bg-[#0f0f0f] transition-colors relative overflow-hidden" delay={100}>
                            ...
                            <h3 className="font-display text-2xl text-[#1A1A1A] dark:text-white mb-2 group-hover:text-brand-orange transition-colors">Fund Performance</h3>
                            <p className="text-[#4B5563] dark:text-gray-300 text-sm leading-relaxed mb-6">
                        ...
                        {/* Finance Card 2 */}
                        <ScrollReveal className="bg-white dark:bg-[#0a0a0a] p-6 md:p-10 group hover:bg-[#0f0f0f] dark:hover:bg-[#0f0f0f] transition-colors relative overflow-hidden" delay={200}>
                            ...
                            <p className="text-brand-orange text-xs font-mono uppercase tracking-wider mb-4">Finance</p>
                            <h3 className="font-display text-2xl text-[#1A1A1A] dark:text-white mb-2 group-hover:text-brand-orange transition-colors">Fraud Patterns</h3>
                            <p className="text-[#4B5563] dark:text-gray-300 text-sm leading-relaxed mb-6">
                        ...
                        {/* Health Card 1 */}
                        <ScrollReveal className="bg-white dark:bg-[#0a0a0a] p-6 md:p-10 group hover:bg-[#0f0f0f] dark:hover:bg-[#0f0f0f] transition-colors relative overflow-hidden" delay={300}>
                            ...
                            <h3 className="font-display text-2xl text-[#1A1A1A] dark:text-white mb-2 group-hover:text-brand-orange transition-colors">Women's Health</h3>
                            <p className="text-[#4B5563] dark:text-gray-300 text-sm leading-relaxed mb-6">
                         ...
                         {/* Health Card 2 */}
                        <ScrollReveal className="bg-white dark:bg-[#0a0a0a] p-6 md:p-10 group hover:bg-[#0f0f0f] dark:hover:bg-[#0f0f0f] transition-colors relative overflow-hidden" delay={400}>
                            ...
                            <p className="text-brand-orange text-xs font-mono uppercase tracking-wider mb-4">Health</p>
                            <h3 className="font-display text-2xl text-[#1A1A1A] dark:text-white mb-2 group-hover:text-brand-orange transition-colors">Sleep Quality</h3>
                            <p className="text-[#4B5563] dark:text-gray-300 text-sm leading-relaxed mb-6">
             ...
             <section className="py-16 md:py-32 px-4 md:px-8">
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col-reverse lg:flex-row gap-12 lg:gap-24 items-end">
                        ...
                        <div className="w-full lg:w-1/2 border-t border-gray-200 dark:border-gray-800 pt-8">
                            <div className="grid sm:grid-cols-2 gap-8">
                                <div>
                                    <h3 className="text-[#6B7280] dark:text-gray-400 mb-1 text-sm font-mono uppercase tracking-wider">Custody</h3>
                                    <p className="text-[#1A1A1A] dark:text-white text-lg">Your plaintext never leaves your control.</p>
                                </div>
                                <div>
                                    <h3 className="text-[#6B7280] dark:text-gray-400 mb-1 text-sm font-mono uppercase tracking-wider">Verification</h3>
                                    <p className="text-[#1A1A1A] dark:text-white text-lg">Access enforced by code, not legal agreements.</p>
                                </div>
                                <div>
                                    <h3 className="text-[#6B7280] dark:text-gray-400 mb-1 text-sm font-mono uppercase tracking-wider">Compliance</h3>
                                    <p className="text-[#1A1A1A] dark:text-white text-lg">Built for GDPR, HIPAA, and the EU AI Act.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="w-full lg:w-1/2 text-left lg:text-right">
                            ...
                            <h2 className="font-display text-3xl md:text-5xl lg:text-6xl leading-[0.9] tracking-tight">
                                ...
                                <span className="italic text-[#6B7280] dark:text-gray-400">not promises you can't.</span>
                            </h2>
                        </div>
                    </div>
                    ...
                    <div className="mt-12 text-center lg:text-right">
                        <Link
                            to="/buyers"
                            className="inline-flex items-center gap-2 text-brand-orange hover:text-white dark:hover:text-[#1A1A1A] transition-colors text-sm font-medium"
                        >
                            For AI Builders
                            <ArrowRight className="w-4 h-4" />
                        </Link>
            ...
            <section className="py-16 md:py-32 px-4 md:px-8 border-t border-gray-200 dark:border-gray-900">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <Link
                            to="/partners"
                            className="px-8 py-4 bg-transparent border border-gray-200 dark:border-gray-800 text-[#1A1A1A] dark:text-white hover:border-gray-400 dark:hover:border-white transition-colors uppercase tracking-wide text-sm"
                        >
                            List Your Data
                        </Link>
                    </div>
